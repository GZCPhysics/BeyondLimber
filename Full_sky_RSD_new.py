...
def curly_Cl1(l, chi_chi, dchi_dchi, c_n_array, path1):
...
def Equation1(l, chi_chi, dchi_dchi, f1_f1, f2_f2, Wg1_Wg1, Wg2_Wg2, c_n_array, path1):
    ...
    chi1 = chi_chi - 0.5*dchi_dchi
    chi2 = chi_chi + 0.5*dchi_dchi
    Cl_array = curly_Cl1(l, chi_chi, dchi_dchi, c_n_array, path1)
...
def curly_Cl2(l, chi_chi, dchi_dchi, c_n_array, path2):
...
def Equation2(l, chi_chi, dchi_dchi, f1_f1, f2_f2, Wg1_Wg1, Wg2_Wg2, c_n_array, path2):
    ...
    Cl_array = curly_Cl2(l, chi_chi, dchi_dchi, c_n_array, path2)
...
def curly_Cl3(l, chi_chi, dchi_dchi, c_n_array, path2):
...
def Equation3(l, chi_chi, dchi_dchi, f1_f1, f2_f2, Wg1_Wg1, Wg2_Wg2, c_n_array, path2):
    ...
    Cl_array = curly_Cl3(l, chi_chi, dchi_dchi, c_n_array, path2)
...
def curly_Cl4(l, chi_chi, dchi_dchi, c_n_array, path3, path4):
    '''
...
def Equation4(l, chi_chi, dchi_dchi, f1_f1, f2_f2, Wg1_Wg1, Wg2_Wg2, c_n_array, path3, path4):
    ...
    chi1 = chi_chi - 0.5*dchi_dchi
    chi2 = chi_chi + 0.5*dchi_dchi
    Cl_array = curly_Cl4(l, chi_chi, dchi_dchi, c_n_array, path3, path4)
...
def curly_Cl5(l, chi_chi, dchi_dchi, c_n_array, path3, path4):
...
def Equation5(l, chi_chi, dchi_dchi, f1_f1, f2_f2, Wg1_Wg1, Wg2_Wg2, c_n_array, path3, path4):
    ...
    chi1 = chi_chi - 0.5*dchi_dchi
    chi2 = chi_chi + 0.5*dchi_dchi
    Cl_array = curly_Cl5(l, chi_chi, dchi_dchi, c_n_array, path3, path4)
...
def curly_Cl6(l, chi_chi, dchi_dchi, c_n_array, path5):
    '''
...
def Equation6(l, chi_chi, dchi_dchi, f1_f1, f2_f2, Wg1_Wg1, Wg2_Wg2, c_n_array, path5):
    ...
    chi1 = chi_chi - 0.5*dchi_dchi
    chi2 = chi_chi + 0.5*dchi_dchi
    Cl_array = curly_Cl6(l, chi_chi, dchi_dchi, c_n_array, path5)
...
def curly_Cl7(l, chi_chi, dchi_dchi, c_n_array, path6, path7):
    '''
...
def Equation7(l, chi_chi, dchi_dchi, f1_f1, f2_f2, Wg1_Wg1, Wg2_Wg2, c_n_array, path6, path7):
    ...
    chi1 = chi_chi - 0.5*dchi_dchi
    chi2 = chi_chi + 0.5*dchi_dchi
    Cl_array = curly_Cl7(l, chi_chi, dchi_dchi, c_n_array, path6, path7)
...
def curly_Cl8(l, chi_chi, dchi_dchi, c_n_array, path6, path7):
    '''
...
def Equation8(l, chi_chi, dchi_dchi, f1_f1, f2_f2, Wg1_Wg1, Wg2_Wg2, c_n_array, path6, path7):
    ...
    chi1 = chi_chi - 0.5*dchi_dchi
    chi2 = chi_chi + 0.5*dchi_dchi
    Cl_array = curly_Cl8(l, chi_chi, dchi_dchi, c_n_array, path6, path7)
...
def curly_Cl9(l, chi_chi, dchi_dchi, c_n_array, path8):
    '''
    path5 is for upper half mesh of mesh5
    '''
...
def Equation9(l, chi_chi, dchi_dchi, f1_f1, f2_f2, Wg1_Wg1, Wg2_Wg2, c_n_array, path8):
    ...
    chi1 = chi_chi - 0.5*dchi_dchi
    chi2 = chi_chi + 0.5*dchi_dchi
    Cl_array = curly_Cl9(l, chi_chi, dchi_dchi, c_n_array, path8)
...
def Equation_0_order(l, chi_chi, dchi_dchi, f1_f1, f2_f2, Wg1_Wg1, Wg2_Wg2, c_n_array, path1):

    results = Equation1(l, chi_chi, dchi_dchi, 0, 0, Wg1_Wg1, Wg2_Wg2, c_n_array, path1)

    return results

def Equation_1_order(l, chi_chi, dchi_dchi, f1_f1, f2_f2, Wg1_Wg1, Wg2_Wg2, c_n_array, path1, path2, path3, path4):

    chi1 = chi_chi - 0.5*dchi_dchi
    chi2 = chi_chi + 0.5*dchi_dchi
    Cl_array1 = curly_Cl1(l, chi_chi, dchi_dchi, c_n_array, path1)
    Cl_array2 = curly_Cl2(l, chi_chi, dchi_dchi, c_n_array, path2)
    Cl_array3 = curly_Cl3(l, chi_chi, dchi_dchi, c_n_array, path2)
    Cl_array4 = curly_Cl4(l, chi_chi, dchi_dchi, c_n_array, path3, path4)
    Cl_array5 = curly_Cl5(l, chi_chi, dchi_dchi, c_n_array, path3, path4)

    Simp_array1 = Cl_array1*(f1_f1+f2_f2)*Wg1_Wg1*Wg2_Wg2*2/np.pi
    Simp_array2 = -(2/np.pi)*Cl_array2*f2_f2*Wg1_Wg1*Wg2_Wg2*l*(l-1)/chi2**2
    Simp_array3 = -(2/np.pi)*Cl_array3*f1_f1*Wg1_Wg1*Wg2_Wg2*l*(l-1)/chi1**2
    Simp_array4 = -(2/np.pi)*2*Cl_array4*f2_f2*Wg1_Wg1*Wg2_Wg2/chi2
    Simp_array5 = -(2/np.pi)*2*Cl_array5*f1_f1*Wg1_Wg1*Wg2_Wg2/chi1

    Simp_array = Simp_array1 + Simp_array2 + Simp_array3 + Simp_array4 + Simp_array5
    intover_dchi = np.array([simps(Simp_array[:,i], dchi_dchi[:,i]) for i in range(len(chi_chi[0,:]))])
    results = simps(intover_dchi, chi_chi[0, :])

    return results

def Equation_2_order(l, chi_chi, dchi_dchi, f1_f1, f2_f2, Wg1_Wg1, Wg2_Wg2, c_n_array, path1, path2, path3, path4, path5, path6, path7, path8):
    ...
    Simp_array1 = Cl_array1*f1_f1*f2_f2*Wg1_Wg1*Wg2_Wg2*2/np.pi
    Simp_array2 = -(2/np.pi)*Cl_array2*f1_f1*f2_f2*Wg1_Wg1*Wg2_Wg2*l*(l-1)/chi2**2
    Simp_array3 = -(2/np.pi)*Cl_array3*f1_f1*f2_f2*Wg1_Wg1*Wg2_Wg2*l*(l-1)/chi1**2
    Simp_array4 = -(2/np.pi)*2*Cl_array4*f1_f1*f2_f2*Wg1_Wg1*Wg2_Wg2/chi2
    Simp_array5 = -(2/np.pi)*2*Cl_array5*f1_f1*f2_f2*Wg1_Wg1*Wg2_Wg2/chi1

    Cl_array6 = curly_Cl6(l, chi_chi, dchi_dchi, c_n_array, path5)
    Simp_array6 = (2/np.pi)*4*Cl_array6*f1_f1*f2_f2*Wg1_Wg1*Wg2_Wg2/chi1/chi2

    Cl_array7 = curly_Cl7(l, chi_chi, dchi_dchi, c_n_array, path6, path7)
    Simp_array7 = (2/np.pi)*2*Cl_array7*f1_f1*f2_f2*Wg1_Wg1*Wg2_Wg2*l*(l-1)/chi2/chi1**2

    Cl_array8 = curly_Cl8(l, chi_chi, dchi_dchi, c_n_array, path6, path7)
    Simp_array8 = (2/np.pi)*2*Cl_array8*f1_f1*f2_f2*Wg1_Wg1*Wg2_Wg2*l*(l-1)/chi2**2/chi1

    Cl_array9 = curly_Cl9(l, chi_chi, dchi_dchi, c_n_array, path8)
    Simp_array9 = (2/np.pi)*Cl_array9*f1_f1*f2_f2*Wg1_Wg1*Wg2_Wg2* l**2 * (l-1)**2 /chi1**2/chi2**2

    Simp_array = Simp_array1 + Simp_array2 + Simp_array3 + Simp_array4 + Simp_array5 + Simp_array6 + Simp_array7 + Simp_array8 + Simp_array9
    intover_dchi = np.array([simps(Simp_array[:,i], dchi_dchi[:,i]) for i in range(len(chi_chi[0,:]))])
    results = simps(intover_dchi, chi_chi[0, :])
...
if __name__ == '__main__':
    ...
    for li in l_list:
        ...
        Cl_0_order = Equation_0_order(li, chi_chi, dchi_dchi, f1_f1, f2_f2, Wg1_Wg1, Wg2_Wg2, c_n_array, path1)
        Cl_1_order = Equation_1_order(li, chi_chi, dchi_dchi, f1_f1, f2_f2, Wg1_Wg1, Wg2_Wg2, c_n_array, path1, path2, path3, path4)
        Cl_2_order = Equation_2_order(li, chi_chi, dchi_dchi, f1_f1, f2_f2, Wg1_Wg1, Wg2_Wg2, c_n_array, path1, path2, path3, path4, path5, path6, path7, path8)

        Cli = Cl_0_order + Cl_1_order + Cl_2_order
        print(li, [Cli, Cl_0_order, Cl_1_order, Cl_2_order])

        Cl_list.append([Cli, Cl_0_order, Cl_1_order, Cl_2_order])
    
    np.save('./Cl_%s_part'%name, Cl_list)
