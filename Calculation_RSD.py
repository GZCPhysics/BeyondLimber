...
def power_calc_sampling_RSD(l, n, chi_chi, dchi_dchi, D1_D1, D2_D2, Wg1_Wg1, Wg2_Wg2, f1_f1, f2_f2, curl_Cl_RSD_mesh, c_n_array,\
    ...
    Cl_array2 = curl_Cl_RSD_mesh(l, chi_chi, dchi_dchi, func_real_list2, func_imag_list2, c_n_array)
    Cl_array31 = curl_Cl_RSD_mesh(l, chi_chi, dchi_dchi, func_real_list3, func_imag_list3, c_n_array)
    Cl_array32 = curl_Cl_RSD_mesh(l, chi_chi, dchi_dchi, func_real_list3, func_imag_list3, c_n_array)
    Cl_array4 = curl_Cl_RSD_mesh(l, chi_chi, dchi_dchi, func_real_list4, func_imag_list4, c_n_array)
...
def full_calc_sampling_RSD(l_array, n, z1, z2, sigma1, sigma2, Nchi, Ndchi, curl_Cl_RSD_mesh, c_n_array, \
    func_real_list2, func_imag_list2, func_real_list3, func_imag_list3, func_real_list4, func_imag_list4):
    '''
    Params:
    ...
    start2 = time.time()
    power_array = [power_calc_sampling_RSD(li, n, chi_chi, dchi_dchi, D1_D1, D2_D2, Wg1_Wg1, Wg2_Wg2, f1_f1, f2_f2, curl_Cl_RSD_mesh, c_n_array,\
...
def power_calc_sampling_RSD_mod(l, n, chi_chi, dchi_dchi, D1_D1, D2_D2, Wg1_Wg1, Wg2_Wg2, f1_f1, f2_f2, curl_Cl_RSD_mesh, c_n_array,\
    func_real_list2, func_imag_list2, func_real_list3, func_imag_list3, func_real_list4, func_imag_list4):
...
def full_calc_sampling_RSD_mod(l_array, n, z1, z2, sigma1, sigma2, Nchi, Ndchi, curl_Cl_RSD_mesh, c_n_array,\
    func_real_list2, func_imag_list2, func_real_list3, func_imag_list3, func_real_list4, func_imag_list4):
    '''
    Params:
    l_array: The array of multiples we have chosen to consider
    ...
    print('Time for preparing mesh-grids is:', end1, 's')
    start2 = time.time()
    power_array = [power_calc_sampling_RSD_mod(li, n, chi_chi, dchi_dchi, D1_D1, D2_D2, Wg1_Wg1, Wg2_Wg2, f1_f1, f2_f2, curl_Cl_RSD_mesh, c_n_array,\
        func_real_list2, func_imag_list2, func_real_list3, func_imag_list3, func_real_list4, func_imag_list4) for li in l_array]
    end2 = (time.time()-start2)/len(l_array)
    print('Time for calculating each l is:', end2, 's')
