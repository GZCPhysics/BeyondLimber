...
def special_func_generator(x_min = 1e-7, x_max = 1e7, N_sample = 2000):
    '''
...
def special_func_generator_CMBlensing(x_min = 1e-6, x_max = 1e5, N_sample = 2000):
    '''
...
def power_calc_sampling(l, n, chi_chi, dchi_dchi, D1_D1, D2_D2, Wg1_Wg1, Wg2_Wg2, c_array, func_real_list, func_imag_list):
    '''
    Params:
    l: The multiple
...
def full_calc_sampling(l_array, n, z1, z2, sigma1, sigma2, Nchi, Ndchi, c_array, func_real_list, func_imag_list):
    '''
    Params:
    ...
    start2 = time.time()
    power_array = [power_calc_sampling(li, n, chi_chi, dchi_dchi, D1_D1, D2_D2, Wg1_Wg1, Wg2_Wg2, c_array, func_real_list, func_imag_list).real for li in l_array]
...
def power_calc_sampling_CMBlensing(l, chi_chi, dchi_dchi, D1_D1, D2_D2, W1_W1, W2_W2, F1_F1, F2_F2, c_array, func_real_list1, func_imag_list1):
    '''
    Params:
    l: The multiple
    n: The order of our approximation, usually order 0 will be good enough
...
def full_calc_sampling_CMBlensing(l_array, Nchi, Ndchi, c_array, func_real_list1, func_imag_list1):
    '''
    Params:
    l_array: The array of multiples we have chosen to consider
    The meaning of rest parameters could be found above
    ...
    print('Time for preparing mesh-grids is:', end1, 's')
    start2 = time.time()
    power_array = [power_calc_sampling_CMBlensing(li, chi_chi, dchi_dchi, D1_D1, D2_D2, W1_W1, W2_W2, F1_F1, F2_F2, c_array, func_real_list1, func_imag_list1).real for li in l_array]
    end2 = (time.time()-start2)/len(l_array)
    print('Time for calculating each l is:', end2, 's')

    return power_array

def power_calc_sampling_CMBlensing_mod(l, chi_chi, dchi_dchi, D1_D1, D2_D2, W1_W1, W2_W2, F1_F1, F2_F2, c_array, func_real_list1, func_imag_list1):
    '''
    Params:
    l: The multiple
    n: The order of our approximation, usually order 0 will be good enough
...
def full_calc_sampling_CMBlensing_mod(l_array, Nchi, Ndchi, c_array, func_real_list1, func_imag_list1):
    '''
    Params:
    l_array: The array of multiples we have chosen to consider
    The meaning of rest parameters could be found above
    ...
    print('Time for preparing mesh-grids is:', end1, 's')
    start2 = time.time()
    power_array = [power_calc_sampling_CMBlensing_mod(li, chi_chi, dchi_dchi, D1_D1, D2_D2, W1_W1, W2_W2, F1_F1, F2_F2, c_array, func_real_list1, func_imag_list1).real for li in l_array]
    end2 = (time.time()-start2)/len(l_array)
    print('Time for calculating each l is:', end2, 's')
